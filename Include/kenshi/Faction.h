...
namespace Kenshi 
{
    ...
    enum DialogConditionEnum
    {
        ...
        DC_PLAYERMONEY = 0x2,
        DC_REPUTATION = 0x3,
        DC_CARRYING_BOUNTY_ALIVE = 0x4,
        DC_CARRYING_BOUNTY_DEAD = 0x5,
        DC_FACTION_VARIABLE = 0x6,
        DC_IMPRISONED_BY_TARGET = 0x7,
        DC_IMPRISONED_BY_OTHER = 0x8,
        DC_IS_A_TRADER = 0x9,
        DC_FACTION_RANK = 0xA,
        DC_BUILDING_IS_CLOSED_AND_SECURED = 0xB,
        DC_PLAYER_TECH_LEVEL = 0xC,
        DC_NUM_DIALOG_EVENT_REPEATS = 0xD,
        DC_IS_IMPRISONED = 0xE,
        DC_IMPRISONMENT_IS_DEATHROW = 0xF,
        DC_TARGET_IN_TALKING_RANGE = 0x10,
        DC_IN_MY_BUILDING = 0x11,
        DC_TARGET_LAST_SEEN_X_HOURS_AGO = 0x12,
        DC_IS_LEADER = 0x13,
        DC_MET_TARGET_BEFORE = 0x14,
        DC_WEAKER_THAN_ME = 0x15,
        DC_STRONGER_THAN_ME = 0x16,
        DC_HAS_TAG = 0x17,
        DC_IS_ALLY = 0x18,
        DC_IS_ENEMY = 0x19,
        DC_PERSONALITY_TAG = 0x1A,
        DC_BROKEN_LEG = 0x1B,
        DC_BROKEN_ARM = 0x1C,
        DC_DAMAGED_HEAD = 0x1D,
        DC_NEARLY_KO = 0x1E,
        DC_IN_A_NON_PLAYER_TOWN = 0x1F,
        DC_IS_RUNNING = 0x20,
        DC_COPS_AROUND = 0x21,
        NULL_NULL_____DC_TARGET_SQUAD_SIZE = 0x22,
        DC_SQUAD_SIZE = 0x23,
        DC_IS_PLAYER = 0x24,
        DC_NUM_BACKPACKS = 0x25,
        DC_SQUAD_ONLY_ANIMALS = 0x26,
        DC_IS_OUTNUMBERED = 0x27,
        DC_BOUNTY_AMOUNT_PERCEIVED = 0x28,
        DC_IS_KO = 0x29,
        DC_IS_NEARLY_KO = 0x2A,
        DC_SQUAD_IS_DOWN = 0x2B,
        DC_IS_DEAD = 0x2C,
        DC_IS_FEMALE = 0x2D,
        DC_CARRYING_SOMEONE_TO_ENSLAVE = 0x2E,
        DC_BOUNTY_AMOUNT_ACTUAL = 0x2F,
        DC_IM_UNARMED = 0x30,
        DC_TOWN_HAS_FORTIFICATIONS_WALLS = 0x31,
        DC_TARGET_IS_MY_MISSION_TARGET = 0x32,
        DC_MY_MISSION_IS_FRIENDLY = 0x33,
        DC_I_LOVE_THIS_GUY = 0x34,
        DC_I_HATE_THIS_GUY = 0x35,
        DC_I_SHOULD_SCREW_THIS_GUY_OVER = 0x36,
        DC_I_SHOULD_HELP_THIS_GUY = 0x37,
        DC_IN_COMBAT = 0x38,
        DC_WITHIN_TOWN_WALLS = 0x39,
        DC_TOWN_WALLS_LOCKED_UP = 0x3A,
        DC_IS_SLAVE = 0x3B,
        DC_HAS_A_BASE_NEARBY = 0x3C,
        DC_TARGET_IS_SLAVE_OF_MY_FACTION = 0x3D,
        DC_IS_ESCAPED_SLAVE = 0x3E,
        DC_IS_IN_LOCKED_CAGE = 0x3F,
        DC_WEARING_LOCKED_SHACKLES = 0x40,
        DC_IS_SAME_RACE_AS_ME = 0x41,
        DC_CAN_AFFORD_BOUNTY = 0x42,
        DC_IS_SNEAKING = 0x43,
        DC_IS_INDOORS = 0x44,
        DC_HAS_ILLEGAL_ITEM = 0x45,
        DC_USING_MY_TRAINING_EQUIPMENT = 0x46,
        DC_STARVING = 0x47,
        DC_MIXED_GENDER_GROUP = 0x48,
        DC_TOWN_LEVEL_CURRENT_LOCATION = 0x49,
        DC_PLAYERS_BEST_TOWN_LEVEL = 0x4A,
        DC_IN_A_PLAYER_TOWN = 0x4B,
        DC_TARGET_CHARACTER_EXISTS = 0x4C,
        DC_IS_RECRUITABLE = 0x4D,
        DC_HAS_AI_CONTRACT = 0x4E,
        DC_HAS_ROBOT_LIMBS = 0x4F,
        DC_END = 0x50
    };
    ...
    {
        UPJOB_NONE = 0x0,
        UPJOB_PATROL_TOWN = 0x1,
        UPJOB_PATROL_SHORTRANGE = 0x2,
        UPJOB_PATROL_LONGRANGE = 0x3,
        UPJOB_GOHOME = 0x4,
        UPJOB_TRAVEL_TARGET = 0x5,
        UPJOB_TRAVEL_TARGET_FAST = 0x6
    };
