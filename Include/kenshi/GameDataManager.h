...
namespace Kenshi
{
    ...
    public:
        ...
        static boost_shim::unordered::unordered_set<GameData*, boost::hash<GameData*>, std::equal_to<GameData*>, Ogre::STLAllocator<GameData*, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > killList; // Static Member
        static void _addToKillList(GameData*);// RVA = 0x55DC60
        boost_shim::unordered::unordered_map<int, boost::unordered::unordered_map<std::string, GameData*, boost::hash<std::string >, std::equal_to<std::string >, Ogre::STLAllocator<std::pair<std::string const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > >, boost::hash<int>, std::equal_to<int>, Ogre::STLAllocator<std::pair<int const, boost::unordered::unordered_map<std::string, GameData*, boost::hash<std::string >, std::equal_to<std::string >, Ogre::STLAllocator<std::pair<std::string const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > >, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > gamedataCatName; // 0x10 Member
        boost_shim::unordered::unordered_map<int, GameData*, boost::hash<int>, std::equal_to<int>, Ogre::STLAllocator<std::pair<int const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > gamedataID; // 0x50 Member
        boost_shim::unordered::unordered_map<int, boost::unordered::unordered_map<std::string, GameData*, boost::hash<std::string >, std::equal_to<std::string >, Ogre::STLAllocator<std::pair<std::string const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > >, boost::hash<int>, std::equal_to<int>, Ogre::STLAllocator<std::pair<int const, boost::unordered::unordered_map<std::string, GameData*, boost::hash<std::string >, std::equal_to<std::string >, Ogre::STLAllocator<std::pair<std::string const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > >, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > gamedataCatSID; // 0x90 Member
        boost_shim::unordered::unordered_map<std::string, GameData*, boost::hash<std::string >, std::equal_to<std::string >, Ogre::STLAllocator<std::pair<std::string const, GameData*>, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > gamedataSID; // 0xD0 Member
        boost_shim::unordered::unordered_set<GameData*, boost::hash<GameData*>, std::equal_to<GameData*>, Ogre::STLAllocator<GameData*, Ogre::CategorisedAllocPolicy<Ogre::MEMCATEGORY_GENERAL> > > mainList; // 0x110 Member
